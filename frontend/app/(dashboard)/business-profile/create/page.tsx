  ...
  const onSubmit = async (data: BusinessProfileFormData) => {
    try {
      ...
      const input: CreateBusinessProfileInput = {
        ...
        exitTimeline: data.exitTimeline as ExitTimeline | undefined,
        description: data.description,
        website: data.website || undefined,
      };

      const profile = await businessProfileAPI.create(input);
      toast.success('Business profile created successfully!');
      router.push(`/business-profile/${profile.id}`);
    } catch (error: any) {
      toast.error(
    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Tell us about your business to get personalized assessments and
          recommendations.
        </p>
      </div>
